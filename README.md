...
This involves two players and an assortment of ships. Each player is given their own set of ships (5) which will be of different variations.
...
A| | | | | | | | |
B| | | | | | | | |
C| | |*|*|*| | | |     board_1[3][3],board_1[3][4],board[3][4];
D| | | | | | | | |
E| | | | | | | | |
F| | | | | | | | |
G| | | | | | | | |
